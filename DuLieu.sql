...
GO
--INSERT [dbo].[Ve] ([ID_VE], [ID_LICH_TRINH], [TONG_TIEN], [NHAN_VIEN_TAO], [TRANG_THAI], [NGAY_DAT_VE], [SOLUONG], [SDT], [TENKHACHHANG], [DIEMDON], [DIEMTRA], [HINHTHUCTHANHTOAN]) VALUES (N'LT003VE003', N'LT003', 280000, N'abcd', N'Hiện tại', CAST(N'2024-12-03 19:38:52.533' AS DateTime), 1, N'0794672267', N'Trần Kháng Dĩ', N'TDC006', N'TDC004', N'Chuyển khoản')
--GO
